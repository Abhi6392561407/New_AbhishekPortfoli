...
import Resume from '../assests/projects/Resume.pdf'
function Navbar() {
  ...
  return (
    ...
    <div className='fixed w-full h-[80px] flex justify-between items-center px-4 bg-[#0a192f] text-gray-300'>
      ...
      {/*hamburger*/}
      <div oncClick={handleClick} className='md:hidden  z-10'>
        {!nav ? <FaBars/> : <FaTimes/>}
      </div>
      ...
      <ul>
        <li className='w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-blue-600 '>
          ...
          href='https://www.linkedin.com/in/abhishek-tiwari-567b50246'>
        ...
        <li className='w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-[#333333] '>
          <a className='flex  justify-around items-center w-full text-gray-300' 
          href='https://github.com/Abhi6392561407/'>
        ...
        <li className='w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-[#6fc2b0] '>
          <a className='flex  justify-around items-center w-full text-gray-300' 
          href='mailto:abhi407tiwari@gmail.com'>
